...
<title>Save Doctor Profile</title>
</head>
<body>
...
if ($spec=="") { $error=1; echo "<tr><td><font color=red size=4>Specilization can't empty</font></td></tr>"; }
if ($error==0) {
...
mysql_query("insert into doct(dname,dspec,dshow) values('".$name."','".$spec."','Y')");
