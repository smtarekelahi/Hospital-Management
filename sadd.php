...
if(isset($_POST['btn-signup']))
{
 ...
 if(mysql_query("INSERT INTO slot(sday,stime) VALUES('$uname','$email')"))
 {
  ?>
...
<tr><td>Enter the name of Days</td><td><input type=text name=name size=30
maxlength=30 required=""></td></tr>
<tr><td>Enter The time</td><td><input type=text name=spec size=30
maxlength=30 required=""></td></tr>
</table></td></tr>
